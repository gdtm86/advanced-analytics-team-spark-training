...
object ApacheLogParserUtil extends Serializable {
  ...
  def parseRecord(logRegex:String, logline: String):(String, String, String, String, String, String, String, String,Long)= {
    ...
    if (matcher.find) {
       ...
       (matcher.group(1),
         matcher.group(2),
         matcher.group(3),
         parse_apache_time(matcher.group(4)).toString(),
         matcher.group(5),
         matcher.group(6),
         matcher.group(7),
         matcher.group(8),
      ...
      (logline,"failed","",date1.toString(),"","","","",0)
    }
  }
